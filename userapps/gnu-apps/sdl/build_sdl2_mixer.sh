...
function dopatch() {
    ...
    patch -Np1 -i ../sdl2-mixer.patch
}

function preparesrc() {
    if [ ! -f ${APP_DIR}.tar.gz ]; then
        echo "========= Downloading ${APP_DIR}.tar.gz ========="
	wget https://www.libsdl.org/projects/SDL_mixer/release/${APP_DIR}.tar.gz
    fi
...
rm -rf ${ROOTDIR}/sdk/include/sdl/SDL_imxer.h
rm -rf ${ROOTDIR}/sdk/lib/libSDL2_imxer.a

cp SDL_mixer.h ${ROOTDIR}/sdk/include/sdl
cp build/.libs/libSDL2_mixer.a ${ROOTDIR}/sdk/lib

echo "========= SDL2-mixer building finished. ========="
