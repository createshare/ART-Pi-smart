  ...
  <div :id="id" ref="table" class="advanced-table">
    <a-spin :spinning="loading">
      <div :class="['header-bar', size]">
        ...
        <div class="actions">
          <a-tooltip title="刷新">
            <a-icon class="action" :type="loading ? 'loading' : 'reload'" @click="refresh"></a-icon>
          </a-tooltip>
          <action-size v-model="sSize" class="action"></action-size>
          <a-tooltip title="列配置">
          ...
          <a-tooltip title="全屏">
            <a-icon class="action" :type="fullScreen ? 'fullscreen-exit' : 'fullscreen'" @click="toggleScreen"></a-icon>
          </a-tooltip>
        </div>
      </div>
      <a-table
