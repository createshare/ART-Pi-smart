<template>
  <div class="side-setting">
    ...
    <setting-item :title="$t('theme.title')">
      ...
      >
        <img-checkbox :title="$t('theme.dark')" img="https://gw.alipayobjects.com/zos/rmsportal/LCkqqYNmvBEbokSDscrm.svg" value="dark"></img-checkbox>
        <img-checkbox :title="$t('theme.light')" img="https://gw.alipayobjects.com/zos/rmsportal/jpRkZQMyYRryryPNtyIC.svg" value="light"></img-checkbox>
        <img-checkbox :title="$t('theme.night')" img="https://gw.alipayobjects.com/zos/antfincdn/hmKaLQvmY2/LCkqqYNmvBEbokSDscrm.svg" value="night"></img-checkbox>
      </img-checkbox-group>
    </setting-item>
    <setting-item :title="$t('theme.color')">
      ...
      >
        <color-checkbox v-for="(color, index) in palettes" :key="index" :color="color" :value="index"></color-checkbox>
      </color-checkbox-group>
    </setting-item>
    <a-divider></a-divider>
    <setting-item :title="$t('navigate.title')">
      ...
      >
        ...
        <img-checkbox :title="$t('navigate.head')" img="https://gw.alipayobjects.com/zos/rmsportal/KDNDBbriJhLwuqMoxcAr.svg" value="head"></img-checkbox>
        <img-checkbox :title="$t('navigate.mix')" img="https://gw.alipayobjects.com/zos/antfincdn/x8Ob%26B8cy8/LCkqqYNmvBEbokSDscrm.svg" value="mix"></img-checkbox>
      </img-checkbox-group>
    </setting-item>
    <setting-item>
      <a-list :split="false">
        ...
        <a-list-item>
          ...
          <a-switch slot="actions" :checked="fixedHeader" size="small" @change="setFixedHeader"></a-switch>
        </a-list-item>
        <a-list-item>
          {{ $t('navigate.fixedSideBar') }}
          <a-switch slot="actions" :checked="fixedSideBar" size="small" @change="setFixedSideBar"></a-switch>
        </a-list-item>
      </a-list>
    </setting-item>
    <a-divider></a-divider>
    <setting-item :title="$t('other.title')">
      <a-list :split="false">
        <a-list-item>
          {{ $t('other.weekMode') }}
          <a-switch slot="actions" :checked="weekMode" size="small" @change="setWeekMode"></a-switch>
        </a-list-item>
        <a-list-item>
          {{ $t('other.multiPages') }}
          <a-switch slot="actions" :checked="multiPage" size="small" @change="setMultiPage"></a-switch>
        </a-list-item>
        <a-list-item>
          {{ $t('other.hideSetting') }}
          <a-switch slot="actions" :checked="hideSetting" size="small" @change="setHideSetting"></a-switch>
        </a-list-item>
      </a-list>
    </setting-item>
    <a-divider></a-divider>
    <setting-item :title="$t('animate.title')">
      <a-list :split="false">
        <a-list-item>
          {{ $t('animate.disable') }}
          <a-switch slot="actions" :checked="animate.disabled" size="small" @change="val => setAnimate({...animate, disabled: val})"></a-switch>
        </a-list-item>
        <a-list-item>
          {{ $t('animate.effect') }}
          <a-select
    ...
    <a-button v-if="isDev" id="copyBtn" :data-clipboard-text="copyConfig" style="width: 100%" icon="copy" @click="copyCode">{{ $t('copy') }}</a-button>
  </div>
</template>
