<template>
  <a-layout-header :class="[headerTheme, 'admin-header']">
    <div :class="['admin-header-wide', layout, pageWidth]">
      ...
      <a-icon v-if="layout !== 'head'" class="trigger" :type="collapsed ? 'menu-unfold' : 'menu-fold'" @click="toggleCollapse"></a-icon>
      <div v-if="layout !== 'side' && !isMobile" class="admin-header-menu" :style="`width: ${menuWidth};`">
        <i-menu class="head-menu" :theme="headerTheme" mode="horizontal" :options="menuData" @select="onSelect"></i-menu>
      </div>
      <div :class="['admin-header-right', headerTheme]">
        ...
        <a-dropdown class="lang header-item">
          <div>
            <a-icon type="global"></a-icon> {{ langAlias }}
          </div>
...
export default {
  name: 'AdminHeader',
  components: { HeaderTime, IMenu, HeaderAvatar },
