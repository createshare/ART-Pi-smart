...
import baseI18n from '@/i18n/base.i18n';
function mergeDefaultI18n(i18n) {
  return {
    messages: {
      CN: { ...baseI18n.messages.CN, ...i18n.messages.CN },
      HK: { ...baseI18n.messages.HK, ...i18n.messages.HK },
      US: { ...baseI18n.messages.US, ...i18n.messages.US },
      JP: { ...baseI18n.messages.JP, ...i18n.messages.JP }
    }
  };
}
export {
